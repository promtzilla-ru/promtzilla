...
- Весь видимый контент сайта должен быть на русском языке.
- Не добавлять английские версии промптов, блоки EN, английские подписи, английские теги и английские плейсхолдеры.
- Текст внутри генерируемых изображений тоже должен быть только на русском языке.
- Если нужен адрес почты, сайт или бренд, выбирать русскую формулировку или кириллический домен; не вставлять латинские шаблоны вроде EMAIL, WEBSITE, COMPANY.


## Правило визуалов для карточек и примеров

- Сначала придумывать сценарий использования и визуальный крючок, потом текстовые плашки.
- Визуал должен считываться в маленьком превью за 1-2 секунды.
- Не перегружать карточку: один главный заголовок, один сильный оффер, 2-3 ключевых преимущества.
- Не использовать пустые плейсхолдеры в итоговых картинках; пример должен выглядеть как готовая работа.
- Для товарных карточек делать фон по смыслу товара: интерьер, поездка, кухня, ванная, спорт, подарок и т.д.
- Текст на изображении только на русском языке, крупный, короткий, без мелкой каши.
